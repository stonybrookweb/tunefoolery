...
$calColorBgDark      = '#1695be'; //'#336633';
$calColorTextOnDark  = '#ffffff'; //'#ffffff';
$calColorBgLight     = '#0dbce7';  //'#ace0ac';
$calColorTextOnLight = '#003300'; //'#003300';
$calColorBgToday     = '#ffe5ac';  //'#ffe5ac';
